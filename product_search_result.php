...
<body>
    ...
    <div class="container" style="padding-top: 100px;">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h2><i class="fa fa-search me-2"></i>Search Results for "<?php echo htmlspecialchars($search_query); ?>"</h2>
                
                <!-- Refine Search -->
                <form class="d-flex mb-3" method="GET" action="actions/product_actions.php">
                    <input type="hidden" name="action" value="search_products">
                    <input class="form-control me-2" type="search" name="query" value="<?php echo htmlspecialchars($search_query); ?>" placeholder="Search products..." aria-label="Search">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <select class="form-select" onchange="filterSearchByCategory(this.value)">
                    ...
                    <div class="col-md-6">
                        <select class="form-select" onchange="filterSearchByBrand(this.value)">
        ...
        <div class="row">
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted">We couldn't find any products matching "<?php echo htmlspecialchars($search_query); ?>"</p>
    ...
    <script>
        function filterSearchByCategory(catId) {
            if (catId) {
                ...
                window.location.href = 'actions/product_actions.php?action=search_products&query=<?php echo urlencode($search_query); ?>';
            }
        }

        function filterSearchByBrand(brandId) {
            if (brandId) {
